...
trunc_len = 2304
data_path = "/home/hui007/tad/video-mamba-suite/video-mamba-suite/temporal-action-localization/hacs_segment_internvideo2_6b_w16_s8/hacs_6b/"
dataset = dict(
    train=dict(
        data_path=data_path,
        block_list=None,
...
model = dict(
    projection=dict(
        ...
        max_seq_len=2304,
        input_pdrop=0.1,
        mamba_cfg=dict(kernel_size=4, use_mamba_type="bssdm")
        use_global=True,
    ),
...
post_processing = dict(
    ...
    external_cls=dict(
        ...
        path="/home/hui007/tad/OpenTAD/data/hacs-1.1.1/classifiers/hacs_UMTv2_6B_k710+K40_f16_frozenTuning.json_converted.json",
        topk=2,
    ),
    save_dict=True,
)
...
work_dir = "exps/hacs/videomambasuite_internvideo6b_uni2"
