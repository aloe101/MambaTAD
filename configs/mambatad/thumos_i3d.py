...
trunc_len = 2304
data_path = "/home/Dataset/DatasetHui/tad/i3d_actionformer_stride4_thumos/i3d_actionformer_stride4_thumos" #"data/thumos-14/features/thumos14_6b/"
dataset = dict(
    train=dict(
        data_path=data_path,
        block_list=None,
...
model = dict(
    projection=dict(in_channels=2048, input_pdrop=0.3, drop_path_rate_out=0.3, use_global=True,
                    mamba_cfg=dict(kernel_size=4, drop_path_rate=0.3, use_mamba_type="bssdm"),),    #, input_pdrop=0.1
    rpn_head=dict(
        type="TriDetHead",
        num_classes=20,
        in_channels=512,
...
work_dir = "exps/thumos/bssdm_i3d"
