...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", default='/home/hui007/tad/OpenTAD/pretrained/vit_g_hybrid_pt_1200e_k710_ft.pth', help="input checkpoint path")
    parser.add_argument("--out_file", default='/home/hui007/tad/OpenTAD/pretrained/vit-giant-p14_videomaev2-hybrid_pt_1200e_k710_ft_my.pth', help="output checkpoint path")
