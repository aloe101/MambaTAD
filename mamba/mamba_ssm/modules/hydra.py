...
from mamba_ssm.modules.ops import hydra_split_conv1d_scan_combined_no_out_proj
...
class Hydra(nn.Module):
    ...
    def forward(self, u, seq_idx=None):
        ...
        if self.use_mem_eff_path:
            out = hydra_split_conv1d_scan_combined_no_out_proj(
                zxbcdt,
                self.conv1d.weight,
                self.conv1d.bias,
                self.dt_limit,
            ...
            return F.linear(out, self.out_proj.weight, bias=self.out_proj.bias)
